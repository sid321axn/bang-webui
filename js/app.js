...
// Endpoint URL for Bangalore Housing price prediction regression model
const housingEndpoint = 'https://ou3anzrj30.execute-api.us-east-1.amazonaws.com/dev/get-price';
...
function sendHousePredictionRequest() {
    ...
    $.ajax({
        ...
        url: housingEndpoint,
        headers: {
            'x-api-key': 'cTi35X0OFo6Ud3zKEO2Po5cvaDsazTGN15eryKLF'
        },
        data: {
            ...
            balcony: $('#balcony').val(),
            size_BHK: $('#size_BHK').val(),
            bath: $('#bath').val(),      
            size_bed: $('#size_bed').val()
        },
        dataType: 'json',
